...
**Дневной двойник**: раз в день из уже согласившихся на `/twin` случайно выбирается один
участник — весь день бот изредка постит от его имени реплики в чате и отвечает на реплаи
к своим постам. Согласие переиспользуется от обычного `/twin`, отдельного opt-in нет;
`/twin_pause` в середине дня сразу останавливает посты от имени этого человека.
