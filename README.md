...
<!-- TODO: скриншоты ниже убраны 2026-08-07 — старые показывали чужой
     инстанс (другой бот/чат/валюта), не этот проект. Нужны свежие скрины
     из реального чата этого бота (кнопка «Открыть казино» → хаб Mini App). -->
