...
build_portrait (короткий 2-4-предложенческий портрет) остаётся отдельным
контрактом для карточки; карточка не смешивает его с другими AI-функциями.
"""
...
async def fetch_user_recent_texts(
    ...
    отсюда, но и напрямую из других AI-сервисов; leading-
