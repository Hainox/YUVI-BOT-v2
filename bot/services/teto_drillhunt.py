...
гарантированно >=1 раз за спин" на стресс-тесте (50 000+ спинов): у
альтернативного варианта "вырезать новый прямоугольник в свободном месте"
гарантия ломалась в ~0.06% спинов, когда один мегаблок 6x6 занимал всю сетку
целиком (см. roadmap.md/отчёт по Тето).
