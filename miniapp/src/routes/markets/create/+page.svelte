<script lang="ts">
	...
	// the real value" convention already used by BET_CHIPS on the sibling
	// bet screen (no dedicated GET /config route exists, and this task's
	// backend scope is exactly the one POST route).
	//
